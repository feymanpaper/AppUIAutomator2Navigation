...
res, ratio = compare_sreen_similarity(str1, str2)
print(ratio*100, "%")


str1 = "   旧设备扫码验证发送短信验证人工申诉 联系客服 "
str2 = "   旧设备扫码验证发送短信验证人工申诉 联系客服 我知道了"
res, ratio = compare_sreen_similarity(str2, str1)
print(ratio*100, "%")
...
res, ratio = compare_sreen_similarity(str1, str3)
print(ratio*100, "%")
...
res, ratio = compare_sreen_similarity(str3, str4)
print(ratio*100, "%")

str5 = "--中国(+86) 540 1841--中国香港(+852) 540 1979--中国澳门(+853) 540 2116--中国台湾(+886) 540 2244"
res, ratio = compare_sreen_similarity(str5, str1)
print(ratio*100, "%")